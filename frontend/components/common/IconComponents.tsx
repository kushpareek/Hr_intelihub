...
export const CogIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15.036-7.026A7.5 7.5 0 0112 4.5v1.5m0 13.5v-1.5a7.5 7.5 0 01-7.5-7.5H3m15.036 7.026A7.5 7.5 0 0112 19.5v-1.5m0-13.5V3A7.5 7.5 0 0119.5 4.5h-1.5m-6.036 12.026A7.5 7.5 0 0112 16.5v1.5m0-13.5V6A7.5 7.5 0 014.5 13.5H3" />
  </svg>
);

export const UserGroupIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-3.741-5.48m-12 5.48a9.094 9.094 0 013.741-.479 3 3 0 01-3.741-5.48m0 5.48l.146.054A9.094 9.094 0 0112 15.692l.146.054m-12 5.48l-.146.054A9.094 9.094 0 0012 21.692l-.146.054M12 12.75a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);

export const BriefcaseIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.073a2.25 2.25 0 01-2.25 2.25h-12a2.25 2.25 0 01-2.25-2.25V14.15M15.75 10.5l-3.75 3.75-3.75-3.75M10.5 14.25h3" />
...
export const UserMinusIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0zM12 9.75a3 3 0 100-6 3 3 0 000 6z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0zM12 9.75V9M12 14.25v-.75M12 9.75a3 3 0 100-6 3 3 0 000 6zm-6.75 4.524A5.978 5.978 0 0112 15a5.978 5.978 0 016.75-1.226" />
...
export const CreditCardIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h6m3-5.25H21.75m-3-5.25H21.75m0 0V4.125c0-.621-.504-1.125-1.125-1.125H4.125A1.125 1.125 0 003 4.125v15.75c0 .621.504 1.125 1.125 1.125h15.75c.621 0 1.125-.504 1.125-1.125V9z" />
  </svg>
);
